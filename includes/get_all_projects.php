...
try {
    ...
    error_log("Fetching all projects for user ID: " . $userId);
    ...
    error_log("Sending response with " . count($projects) . " projects");
    ...
    error_log("Error in get_all_projects.php: " . $e->getMessage());
